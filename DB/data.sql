...
INSERT INTO users (email, password, first_name, last_name, city, department_id, role_id) VALUES 
('admin@admin', 'password', 'Admin', 'Admin', 'Warszawa', NULL, 1),
('dyrektor@com', 'password', 'Joanna', 'Malinowska', 'Krakow', NULL, 2),
('kierownik@com', 'password', 'Elzbieta', 'Zielinska', 'Gdansk', 1, 3),
('pracownik1@com', 'password', 'Pawel', 'Nowak', 'Łodz', 1, 4),
('pracownik2@com', 'password', 'Michal', 'Wisniewski', 'Wroclaw', 1, 4),
('kierownik2@com', 'password', 'Katarzyna', 'Kowalczyk', 'Poznan', 2, 3),
('pracownik3@com', 'password', 'Tomasz', 'Kaminski', 'Szczecin', 2, 4),
('pracownik4@com', 'password', 'Rafal', 'Lewandowski', 'Lublin', 2, 4),
('kierownik3@com', 'password', 'Magdalena', 'Wojcik', 'Katowice', 3, 3),
('pracownik5@com', 'password', 'Lukasz', 'Kaczmarek', 'Bydgoszcz', 3, 4),
('pracownik6@com', 'password', 'Marcin', 'Piotrowski', 'Rzeszow', 3, 4),
('kierownik4@com', 'password', 'Beata', 'Dabrowska', 'Bialystok', 4, 3),
('pracownik7@com', 'password', 'Patryk', 'Szymanski', 'Gdynia', 4, 4),
('pracownik8@com', 'password', 'Jakub', 'Wojciechowski', 'Opole', 4, 4),
('kierownik5@com', 'password', 'Aneta', 'Kubiak', 'Torun', 5, 3),
('pracownik9@com', 'password', 'Dawid', 'Lis', 'Olsztyn', 5, 4),
('pracownik10@com', 'password', 'Wojciech', 'Mazur', 'Kielce', 5, 4),
('kierownik6@com', 'password', 'Renata', 'Kaczmarczyk', 'Radom', 6, 3),
('pracownik11@com', 'password', 'Mateusz', 'Jankowski', 'Zielona Gora', 6, 4),
('pracownik12@com', 'password', 'Sebastian', 'Olszewski', 'Siedlce', 6, 4),
('kierownik7@com', 'password', 'Urszula', 'Sikora', 'Koszalin', 7, 3),
('pracownik13@com', 'password', 'Adrian', 'Gorski', 'Pila', 7, 4),
('pracownik14@com', 'password', 'Bartosz', 'Pawlak', 'Leszno', 7, 4),
('kierownik8@com', 'password', 'Ewelina', 'Grabowska', 'Czestochowa', 8, 3),
('pracownik15@com', 'password', 'Grzegorz', 'Bak', 'Jelenia Gora', 8, 4),
('pracownik16@com', 'password', 'Karina', 'Wrobel', 'Nowy Sacz', 8, 4),
('kierownik9@com', 'password', 'Mariusz', 'Krol', 'Walbrzych', 9, 3),
('pracownik17@com', 'password', 'Lena', 'Czarnecka', 'Tarnow', 9, 4),
('pracownik18@com', 'password', 'Dominik', 'Sosnowski', 'Przemysl', 9, 4),
('kierownik10@com', 'password', 'Natalia', 'Wasilewska', 'Elblag', 10, 3),
('pracownik19@com', 'password', 'Zofia', 'Baran', 'Plock', 10, 4),
('pracownik20@com', 'password', 'Marek', 'Stanek', 'Zamosc', 10, 4),
('kierownik11@com', 'password', 'Tadeusz', 'Borkowski', 'Chelm', 11, 3),
('pracownik21@com', 'password', 'Joanna', 'Michalak', 'Legnica', 11, 4),
('pracownik22@com', 'password', 'Mikolaj', 'Gajda', 'Gorzow Wielkopolski', 11, 4),
('kierownik12@com', 'password', 'Edyta', 'Maj', 'Slupsk', 12, 3),
('pracownik23@com', 'password', 'Izabela', 'Szewczyk', 'Tczew', 12, 4),
('pracownik24@com', 'password', 'Przemyslaw', 'Walczak', 'Elk', 12, 4),
('kierownik13@com', 'password', 'Bartlomiej', 'Tomczyk', 'Ostroleka', 13, 3),
('pracownik25@com', 'password', 'Alicja', 'Markowska', 'Starachowice', 13, 4),
('pracownik26@com', 'password', 'Kamil', 'Jablonski', 'Konin', 13, 4);
